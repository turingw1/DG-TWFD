...
def _parse_args() -> argparse.Namespace:
    ...
    parser.add_argument("--output-root", default="runs/qualitative_cifar10_class_locked_20260501")
    ...
    manifest["omitted"] = [
        {
            ...
            "reason": "Current active environment has Python 3.13 and lacks jax/flax/ml_collections/tensorflow; these models are unconditional for class labels, so they belong in a separate seed-only panel after a compatible JAX env is available.",
        }
    ]
