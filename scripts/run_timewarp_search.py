...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Run fm_timewarp_sampling Phase B1 gamma search")
    ...
    parser.add_argument("--steps", nargs="+", type=int, default=[4, 8, 16, 25, 32], help="Step counts to compare")
...
def main() -> None:
    ...
    from dgfm.evaluators import TimewarpSearchRunner
