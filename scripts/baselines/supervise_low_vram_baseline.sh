...
start_guard() {
  ...
  (
    ...
    export BASELINE_START_MAX_MB="${BASELINE_START_MAX_MB:-70000}"
    export BASELINE_KILL_MAX_MB="${BASELINE_KILL_MAX_MB:-76000}"
    ...
    export BASELINE_PAUSE_FOR_MAIN_TRAIN="${BASELINE_PAUSE_FOR_MAIN_TRAIN:-0}"
    export BASELINE_PAUSE_FOR_MAIN_EVAL="${BASELINE_PAUSE_FOR_MAIN_EVAL:-0}"
