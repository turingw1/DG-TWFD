...
| E5 | e500c | `edm_first_cifar10_smoke` | `experiments/edm_first/configs/cifar10_edm_map_warp_smoke.yaml` | `bash experiments/edm_first/scripts/launch_all.sh experiments/edm_first/configs/cifar10_edm_map_warp_smoke.yaml edm_first_cifar10_smoke_e500c` | isolated EDM-first smoke: verify continuous teacher transition, student map, learned warp, checkpoint, eval, and fixed-seed grids | completed: 20 train steps, 128-sample eval, non-noise CIFAR-like grids |
| E5 | e501a | `edm_first_cifar10_warp` | `experiments/edm_first/configs/cifar10_edm_map_warp_8h.yaml` | `bash experiments/edm_first/scripts/launch_train.sh experiments/edm_first/configs/cifar10_edm_map_warp_8h.yaml edm_first_cifar10_warp_e501a` | first long EDM-first learned-warp run; test whether continuous EDM teacher gives usable few-step samples | completed: 2000 steps, approx FID@1024 `339.01/106.23/53.83/39.46` for `1/2/4/8` steps |
| E5 | e501a-identity | `edm_first_cifar10_identity_eval` | `experiments/edm_first/configs/cifar10_edm_map_identity_eval.yaml` | `bash experiments/edm_first/scripts/launch_eval.sh experiments/edm_first/configs/cifar10_edm_map_identity_eval.yaml edm_first_cifar10_identity_e501a runs/edm_first_cifar10_warp_e501a/checkpoints/best.pt` | same checkpoint identity-clock eval; isolate current learned-warp schedule effect | completed: approx FID@1024 `339.01/124.48/61.10/38.84` for `1/2/4/8` steps |
| E5 | e501ref | `edm_cifar10_public_eval` | `configs/experiment/edm_cifar10_public_eval.yaml` | `python scripts/run_edm_cifar10_eval.py --config configs/experiment/edm_cifar10_public_eval.yaml --sample-root runs/edm_cifar10_public_eval_e501ref/samples --eval-root eval/edm_cifar10_public_eval_e501ref --steps 1 2 4 8 --num-samples 1024 --batch 64` | official EDM CIFAR-10 checkpoint reference at same sample count | completed: official-protocol FID@1024 `679.611/473.607/115.246/33.0675` for sampler steps `1/2/4/8` |
| E5 | e502a | `edm_first_cifar10_warp_b128` | `experiments/edm_first/configs/cifar10_edm_map_warp_8h_b128.yaml` | `bash experiments/edm_first/scripts/launch_train.sh experiments/edm_first/configs/cifar10_edm_map_warp_8h_b128.yaml edm_first_cifar10_warp_e502a runs/edm_first_cifar10_warp_e501a/checkpoints/best.pt` | extended continuation from `e501a` best with batch 128; test whether longer training and higher memory use improve the EDM-first student | completed partial: stopped after step-5000 checkpoint; learned-warp FID@2048 `337.45/151.78/56.76/35.67`, identity-clock FID@2048 `337.45/140.76/54.24/26.89` |

## Execution order

0. Current route change: DDPM `e402a` and DDPM `oss001` are paused after
   `e405b/e406a/e407a`; EDM-first E5 is the active route.
